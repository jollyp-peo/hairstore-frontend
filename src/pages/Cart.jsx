        ...
        <div className="container mx-auto px-4 lg:px-8 py-16">
          <div className="max-w-md mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-8">
              Discover our luxury hair collection and add some items to your cart.
            </p>
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-hero text-white py-12">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <p className="text-white/90">Review your items and proceed to checkout</p>
        </div>
      </div>
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <Button
                          variant="ghost"
                          size="icon"
                          onClick={() => removeFromCart(item.id, item.length, item.color)}
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex items-center gap-2">
                            <Button
                              ...
                              onClick={() => updateQuantity(item.id, item.length, item.color, item.quantity - 1)}
                            >
            ...
            <div className="bg-card rounded-2xl shadow-card p-6 sticky top-8">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex justify-between">
                  <span>Subtotal:</span>
                  <span>{subtotal.toLocaleString("en-NG", {
													style: "currency",
													currency: "NGN",
												})}</span>
                </div>
                ...
                <div className="border-t border-border pt-4">
                  <div className="flex justify-between text-lg font-bold">
                    <span>Total:</span>
                    <span className="text-primary">{total.toLocaleString("en-NG", {
													style: "currency",
													currency: "NGN",
												})}</span>
                  </div>
